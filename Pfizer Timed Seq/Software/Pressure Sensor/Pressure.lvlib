...
<Library LVVersion="18008000">
	...
	<Item Name="Pressure Reads.vi" Type="VI" URL="../Pressure Reads.vi"/>
	<Item Name="Pressure Settings.vi" Type="VI" URL="../Pressure Settings.vi"/>
	<Item Name="PT (Main).vit" Type="VI" URL="../PT (Main).vit"/>
	<Item Name="PT Configuration.ctl" Type="VI" URL="../PT Configuration.ctl"/>
</Library>
